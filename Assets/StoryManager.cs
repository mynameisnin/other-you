...
public class StoryManager : MonoBehaviour
{
    ...
    {
        "7명의 신들이 고요한 회의실에 모여 있었다.\n그들은 세상을 다스릴 방법에 대해 고심하며 신성한 논의를 이어가고 있었다.",
        "그러던 중, 분노의 여신이 자리에서 일어나 무겁게 입을 열었다.\n“나는 더 이상 관찰자로 머물지 않겠다. 신의 권한으로 인간을 직접 통치하겠다.”",
        "그녀의 목소리는 단호하고 강렬했으며,\n방 안의 공기를 얼어붙게 만들었다.",
        "정의의 여신은 즉각적으로 반응했다.\n“그것은 신성한 균형을 깨뜨리는 행위다.\n우리는 지켜보는 자로서 세상의 조화를 유지해야 한다. 인간은 자유로워야 한다.”",
        "분노의 여신은 짧은 침묵 속에서 정의의 여신의 말을 곱씹었지만,\n이내 그녀의 얼굴엔 억눌리지 않은 분노가 떠올랐다.",
        "“네가 말하는 조화는 허울뿐이다.\n세상은 혼돈 속에 있고, 나는 그 혼돈을 바로잡을 것이다.\n너희의 반대에도 나는 내 길을 갈 것이다.”",
